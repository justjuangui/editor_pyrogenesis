EditorWindow.prototype.ClassSetupWindowPages.MenusPage = class
{
	constructor(setupWindow)
	{
		...
		this.menuButton.caption = this.Caption;
		...
		let handlerMenuButtons = Object.keys(this.Menus).sort(
			(a, b) => (this.Menus[a].ORDER || -1) - (this.Menus[b].ORDER || -1)
		);
		...
		this.buttons = handlerMenuButtons.map((handlerName, i) => {
			let handler = new this.Menus[handlerName](this, menuButtons[i]);
...
let editorMenus = EditorWindow.prototype.ClassSetupWindowPages.MenusPage.prototype;

editorMenus.Speed = 1.2;
editorMenus.Caption = translate("Menu");

Object.defineProperty(editorMenus, "Menus", {
	"value": {},
	"enumerable": false,
	"writable": true,
});
